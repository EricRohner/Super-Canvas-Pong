...
class GameControls extends Component {
  ...
  // return a new player object updated with the red value (0-255)
      ...
      <main className="controlBody">
        <section className="top">
          ...
          <input className="ballVelocity"
                 onChange={(e) => this.props._updateState(this.props.player1, this.props.player2, this._changeBallVelocity(e.target.value))}
                 type="range" min="1" max="3" />
        </section>
        <section>
          <label htmlFor="P1Red">P1 red: </label>
          <input className="P1Red"
                 onChange={(e) => this.props._updateState(this._changeRed(e.target.value, this.props.player1), this.props.player2, this.props.ball)}
                 type="range" min="0" max="255" />
          <label htmlFor="P1Green">P1 green: </label>
          <input className="P1Green"
                 onChange={(e) => this.props._updateState(this._changeGreen(e.target.value, this.props.player1), this.props.player2, this.props.ball)}
                 type="range" min="0" max="255" />
          <label htmlFor="P1Blue">P1 blue: </label>
          <input className="P1Blue"
                 onChange={(e) => this.props._updateState(this._changeBlue(e.target.value, this.props.player1), this.props.player2, this.props.ball)}
                 type="range" min="0" max="255" />
        </section>
        <section>
          <label htmlFor="P2Red">P2 red: </label>
          <input className="P2Red"
                 onChange={(e) => this.props._updateState(this.props.player1, this._changeRed(e.target.value, this.props.player2), this.props.ball)}
                 type="range" min="0" max="255" />
          <label htmlFor="P2Green">P2 green: </label>
          <input className="P2Green"
                 onChange={(e) => this.props._updateState(this.props.player1, this._changeGreen(e.target.value, this.props.player2), this.props.ball)}
                 type="range" min="0" max="255" />
          <label htmlFor="P2Blue">P2 blue: </label>
          <input className="P2Blue"
                 onChange={(e) => this.props._updateState(this.props.player1, this._changeBlue(e.target.value, this.props.player2), this.props.ball)}
                 type="range" min="0" max="255" />
        </section>
        <section>
          <label htmlFor="ballRed">Ball red: </label>
          <input className="ballRed"
                 onChange={(e) => this.props._updateState(this.props.player1, this.props.player2, this._changeRed(e.target.value, this.props.ball))}
                 type="range" min="0" max="255" />
          <label htmlFor="ballGreen">Ball green: </label>
          <input className="ballGreen"
                 onChange={(e) => this.props._updateState(this.props.player1, this.props.player2, this._changeGreen(e.target.value, this.props.ball))}
                 type="range" min="0" max="255" />
          <label htmlFor="ballBlue">Ball blue: </label>
          <input className="ballBlue"
                 onChange={(e) => this.props._updateState(this.props.player1, this.props.player2, this._changeBlue(e.target.value, this.props.ball))}
                 type="range" min="0" max="255" />
        </section>
        <section>
