...
// we only want to call our recursive getConfiguration function once so put it in componentDidMount
  ...
  // this updates the big three state variables all at once
  ...
  // since everything's available through props but the code in gameControls is easier to read this way
  _updateP1 = (player1) => {
